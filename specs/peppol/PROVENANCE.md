...
| | |
|---|---|
| `poacc/examples/` | `InvoiceResponse_Example.xml`, `MessageLevelResponse_Example.xml` and the thirteen `T111-uc*` use cases — one per business situation a response reports — plus `DespatchAdvice_Example.xml` and its five use cases, `Order_Example.xml` and its six, `OrderResponse_Example.xml` and its five, and the advanced ordering scenarios — order changes, cancellations and agreements |
| `poacc/unit-invoice-response/`, `poacc/unit-despatch-advice/`, `poacc/unit-order/`, `poacc/unit-order-response/`, `poacc/unit-order-change/`, `poacc/unit-order-cancellation/`, `poacc/unit-order-response-advanced/` | Peppol's unit corpora: each case names how many times a rule should fire |
...
| `poacc/rules/` | `PEPPOLBIS-T111.xslt`, `PEPPOLBIS-T71.xslt`, `PEPPOLBIS-T16.xslt`, `PEPPOLBIS-T01.xslt`, `PEPPOLBIS-T76.xslt`, `PEPPOLBIS-T110.xslt`, `PEPPOLBIS-T114.xslt`, `PEPPOLBIS-T115.xslt`, `PEPPOLBIS-T116.xslt` |
