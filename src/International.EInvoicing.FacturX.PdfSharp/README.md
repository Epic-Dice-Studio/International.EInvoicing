...
It embeds the CII payload into a PDF and extracts it back out, with the Factur-X XMP metadata. It does not
turn a plain PDF into a PDF/A-3 one: start from a PDF/A-conforming document if the receiver requires it.
